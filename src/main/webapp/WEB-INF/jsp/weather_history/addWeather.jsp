...
<script src="http://code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script> <!--  datepicker 에서만 사용되는 js -->
		...
		<div class="contents d-flex">
			...
			<nav class="col-2">
				...
				<ul class="nav flex-column mt-4">
					...
					<li class="nav-item">
						<a href="/lesson05/add-weather-view" class="nav-link menu-font">날씨입력</a>
					</li>
					<li class="nav-item">
			...
			<section class="col-10 mt-3 ml-5">
				<h3>날씨 입력</h3>
				<form method="post" action="/lesson05/add-weather-complete">
